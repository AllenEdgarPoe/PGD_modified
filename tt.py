...
def main():
    ...
    train_batch_sampler = BatchSampler(sampler=RandomSampler(train_dataset), batch_size=512, multiscale_step=1, drop_last=True, img_sizes=[64])
    ...
    for epoch in range(0, 160):
        ...
        if best_prec + best_adv_prec < prec + adv_prec:
            ...
            torch.save(model, './result2/WRN28_at_tiny')
